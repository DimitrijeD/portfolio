...
<body>
	...
	<h3>Није обавезно унети исправну имејл адресу. Нећете бити контактирани на унету адресу, нити ће ваши подаци бити коришћени. Да бисте приступили сајту морате се регистровати. Хвала на разумевању.</h3>
	<br>
